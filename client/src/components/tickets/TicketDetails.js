...
class TicketDetails extends PureComponent {
  ...
  componentWillMount() {
      ...
      // this.props.getEvent(this.props.ticket.event.id) 
  }
  ...
  //     const allPrices = this.props.event.tickets.map(ticket => ticket.price)
  //     const totalPrices = allPrices.reduce((a, b) => a+ b)
  //     const averagePrice = totalPrices/this.props.event.tickets.length
